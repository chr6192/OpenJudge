...
from open_judge.graders.base_grader import BaseGrader, GraderMode, GraderScore
from open_judge.graders.multimodal._internal import MLLMImage, format_image_content
from open_judge.graders.schema import GraderScoreCallback
...
class ImageEditingGrader(BaseGrader):
    ...
    Example:
        ...
        >>> from open_judge.multimodal import ImageEditingGrader, MLLMImage
        >>>
