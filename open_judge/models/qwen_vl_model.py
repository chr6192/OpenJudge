...
from open_judge.models.schema.qwen.mllmImage import MLLMImage
...
class QwenVLModel(BaseChatModel):
    ...
    Example:
        >>> from open_judge.model.qwen_vlm_api import QwenVLAPI
        >>> from open_judge.metrics.multimodal.schema import MLLMImage
        >>>
        >>> # Initialize
        >>> api = QwenVLAPI(
    ...
    def generate(
        ...
        try:
            ...
            if output_schema:
                from open_judge.utils.utils import trim_and_load_json
